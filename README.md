# A shameless fork of [Luke Smith's](https://github.com/LukeSmithxyz) build of st - the simple (suckless) terminal
...
+ Default font is system "mono" at 11pt, meaning the font will match your
  system font.
+ Dynamic padding using the relative border patch
